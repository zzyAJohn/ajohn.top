...
export default defineUserConfig({
  ...
  theme: plumeTheme({
    ...
    footer: { 
      message: '<div style="display: inline-flex; align-items: center; gap: 10px;"><a href="https://beian.miit.gov.cn/">鄂ICP备2025095120号-1</a> <a href="https://beian.mps.gov.cn/#/query/webSearch?code=42011102005705" target="_blank" style="display: inline-flex; align-items: center;"><img src="https://oss.ajohn.top/blog/beian.png" style="height: 20px; margin-right: 5px;" />鄂公网安备42011102005705号</a></div>', 
