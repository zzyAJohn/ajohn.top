---
title: Shakira - Zoo 2025
createTime: 2025/12/23 17:14:09
permalink: /music/yykv7fpx/
---
...
| English Lyrics | 中文翻译 |
|----------------|-----------|
| Co<u>me on</u>, ge<u>t o</u> <u>n u</u>p(don-na-p) | 快点，一起嗨起来 |
| We're wil==d an==~~d~~ we can'~~t~~ be tame~~d~~^延^ | 我们狂野不羁，拒绝被驯服 |
| An~~d~~ we're turnin' the floo==r in==to | 今晚我们要把舞池变成 |
...
| English Lyrics | 中文翻译 |
|----------------|-----------|
| We ==live in a==(living-ne) **crazy world**^换^, ==caught up in a==(cau-dao-pin-ne) ra~~t~~ race^换^ | 我们活在一个疯狂又内卷的世界 |
| Concre~~te~~ **jungle life**^换^ ~~is~~ sometime==s a== ma~~d~~ place^换^ | 钢铁丛林的生活有时令人发狂 |
| It's you an~~d~~ me together^换^ a~~t~~ the(they) ==end of a== wil~~d~~ day^换^ | 在疯狂的一天结束后，你和我在一起 |
| Don'~~t~~ kee==p it *all*== bottle==d u==~~p~~^换^, an~~d~~ release your energy(J) | 别再压抑自己，释放你的能量 |

| English Lyrics | 中文翻译 |
|----------------|-----------|
| Hey, oh-ayy, only reason we are **her~~e~~** is(he-ris) to **celebrate** | 嗨，来吧，我们来这里就是为了狂欢 |
| I==n a== place where anyone can be anything | 在这里，任何人都可以成为任何样子 |
| Hol==d on== to this momen~~t~~, don'~~t~~ le==t i==~~t~~ fa==de a==way | 抓住这一刻，别让它消逝 |
| Baby, kee~~p~~ the music playin' | 宝贝，让音乐继续响起 |
